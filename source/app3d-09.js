    ...
    .data
        ...
        tarnslate11 \\d\\q 0.0,\\-\\4.310,\\-\\5.30
    ...
    function SystemInit(){
        ...
        mat4.rotateY(matrix1,matrix2,angleY42)
        ...
        Math.podziel(screen.fwidth,screen.fheight,aspect112)
        ...
        shader1.CreateShader('shaders\color.vert','shaders\color.frag')
