    ...
    class cMESH{
        ...
        ModelRender(count1,diffuse1,normal1){
            ...
            //SHADER_SetUniform1i(shader1, 'normalTexture', 1)
    ...
    class cMODEL{
        ...
        CreateGeometry(){
            ...
            file.ReadFile('models\eline\modelNums.bin', modelNums1)
            //printf('nums1... %i, %s', word ptr modelNums1\\+0*2,EOL)
    
    
            hfile1 = CreateFile('models\eline\model.bin', GENERIC_READ or GENERIC_WRITE,0,0,OPEN_EXISTING,FILE_ATTRIBUTE_ARCHIVE, 0)
            ...
            LoadTexture('models\eline\textures\bg.jpg', textures[1])
LoadTexture('models\eline\textures\red.jpg', textures[2])
LoadTexture('models\eline\textures\skin.jpg', textures[3])
LoadTexture('models\eline\textures\bg.jpg', textures[4])
LoadTexture('models\eline\textures\bg.jpg', textures[5])
LoadTexture('models\eline\textures\red.jpg', textures[6])
LoadTexture('models\eline\textures\skin.jpg', textures[7])
LoadTexture('models\eline\textures\bg.jpg', textures[8])
LoadTexture('models\eline\textures\skin.jpg', textures[9])
LoadTexture('models\eline\textures\bg.jpg', textures[10])
LoadTexture('models\eline\textures\red.jpg', textures[11])
LoadTexture('models\eline\textures\red.jpg', textures[12])
LoadTexture('models\eline\textures\red.jpg', textures[13])
LoadTexture('models\eline\textures\bg.jpg', textures[14])
LoadTexture('models\eline\textures\bg.jpg', textures[15])
LoadTexture('models\eline\textures\skin.jpg', textures[16])
LoadTexture('models\eline\textures\bg.jpg', textures[17])
LoadTexture('models\eline\textures\bg.jpg', textures[18])
LoadTexture('models\eline\textures\bg.jpg', textures[19])
LoadTexture('models\eline\textures\bg.jpg', textures[20])
LoadTexture('models\eline\textures\bg.jpg', textures[21])
LoadTexture('models\eline\textures\skin.jpg', textures[22])
LoadTexture('models\eline\textures\skin.jpg', textures[23])
LoadTexture('models\eline\textures\skin.jpg', textures[24])
LoadTexture('models\eline\textures\skin.jpg', textures[25])
LoadTexture('models\eline\textures\skin.jpg', textures[26])
LoadTexture('models\eline\textures\bg.jpg', textures[27])
